...
public class TesteInsercaoBusca {
    public static void testeInsercaoOrdenada(Arvore arvore, int[] numeros) {
        try {
            ...
            System.out.println("Tempo de inserção ordenada (" + numeros.length + " elementos): " + duration + " nanossegundos");
        } catch (Exception e) {
    ...
    public static void testeInsercaoInversa(Arvore arvore, int[] numeros) {
        try {
            ...
            long endTime = System.nanoTime();
            long duration = endTime - startTime;
            System.out.println("Tempo de inserção inversa (" + numeros.length + " elementos): " + duration + " nanossegundos");
        } catch (Exception e) {
    ...
    public static void testeInsercaoAleatoria(Arvore arvore, int[] numeros) {
        try {
            ...
            long endTime = System.nanoTime();
            long duration = endTime - startTime;
            System.out.println("Tempo de inserção aleatória (" + numeros.length + " elementos): " + duration + " nanossegundos");
        } catch (Exception e) {
